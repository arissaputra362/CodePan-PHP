                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <div class="img-area laptop">
                                <img src="./img/layanan/laptop.png" alt="">
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <div class="img-area phone">
                                <img src="./img/layanan/iphone.png" alt="">
                            </div>
                            <div class="selengkapnya">
                                <a href="" class="hvr-icon-wobble-horizontal"> SELENGKAPNYA <i
                                        class="fa fa-arrow-right hvr-icon"></i></a>
                ...
                <div>
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <div class="img-area">
                                <img src="./img/layanan/chart.png" alt="">
                            </div>
                            <div class="selengkapnya">
                                <a href="" class="hvr-icon-wobble-horizontal">SELENGKAPNYA <i
                                        class="fa fa-arrow-right hvr-icon"></i></a>
                ...
                <div>
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <div class="img-area">
                                <img src="./img/layanan/recycle.png" alt="">
                            </div>
                            <div class="selengkapnya">
                                <a href="" class="hvr-icon-wobble-horizontal">SELENGKAPNYA <i
                                        class="fa fa-arrow-right hvr-icon"></i></a>
                ...
                <div>
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <div class="img-area">
                                <img src="./img/layanan/document.png" alt="">
                            </div>
                            <div class="selengkapnya">
                                <a href="" class="hvr-icon-wobble-horizontal">SELENGKAPNYA <i
                                        class="fa fa-arrow-right hvr-icon"></i></a>
