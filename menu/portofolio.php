            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-5">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="#" onclick="moveMenuNav(this)">PORTOFOLIO <span
                                    class="sr-only">(current)</span></a>
                        </li>
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#all"
                            onclick="refreshAos()"><span>All</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#pengadaan-it"
                            onclick="refreshAos()"><span>Pengadaan IT</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#aplikasi-mobile"
                            onclick="refreshAos()"><span>Aplikasi Mobile</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#sistem-informasi"
                            onclick="refreshAos()"><span>Sistem Informasi</span></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#aplikasi-egov"
                            onclick="refreshAos()"><span>Aplikasi E-Gov</span></a>
                    </li>
                </ul>
